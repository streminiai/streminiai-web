  ...
  return (
    <div className="w-full h-full bg-[#0b141a] flex flex-col">
      ...
      <div className="bg-[#1f2c34] px-4 pt-12 pb-3 flex items-center gap-3">
        ...
        <div className="w-10 h-10 rounded-full bg-gray-600 overflow-hidden relative border-2 border-[#1f2c34] shadow-[0_0_10px_rgba(0,0,0,0.5)] z-10 flex-shrink-0">
          <Image src="https://picsum.photos/100/100" alt="avatar" fill sizes="40px" className="object-cover" />
        </div>
