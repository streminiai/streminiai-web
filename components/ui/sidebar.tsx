...
export const SidebarLink = ({
    ...
    return (
        <a
            href={link.href}
            className={cn(
                "flex items-center justify-start gap-2 group/sidebar py-2 hover:text-primary transition-colors",
                className
            )}
            {...props}
        >
            ...
            <motion.span
                ...
                className="text-foreground text-sm group-hover/sidebar:translate-x-1 group-hover/sidebar:text-primary transition duration-150 whitespace-pre inline-block !p-0 !m-0"
            >
                {link.label}
            </motion.span>
        </a>
