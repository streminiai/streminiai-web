...
const tiers = [
  {
    name: "Free",
    price: "$0",
    features: ["Basic protection", "AI keyboard lite", "Community support"],
    cta: "Get Started",
  },
  {
    name: "Pro",
    price: "$12/mo",
    features: ["Full protection", "Voice automation", "Priority support", "Advanced AI keyboard"],
  ...
  },
  {
    name: "Enterprise",
    price: "Custom",
    features: ["SAML/SSO", "Advanced compliance", "Dedicated support", "Custom integrations"],
    cta: "Contact Sales",
  },
]
