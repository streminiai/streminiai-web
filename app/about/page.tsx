    ...
    <div className="mx-auto max-w-5xl px-4 py-12">
      ...
      <header className="mb-10 space-y-3">
        ...
        <p className="text-pretty text-muted-foreground">
          We are a united team, focused on a mission to make the digital world safer and smarter. We’re building an
          AI-powered floating assistant designed to protect your device from online scams and digital threats while
          enhancing your productivity and convenience.
        </p>
      </header>
